		...
		extend: {
			...
			keyframes: {
				...
				'neon-pulse': {
					...
					'50%': {
						boxShadow: '0 0 30px hsl(270 95% 65% / 0.5)',
						opacity: '0.8'
					}
				},
				'float': {
				...
				'glow': {
					'0%, 100%': { 
						filter: 'brightness(1) drop-shadow(0 0 10px hsl(270 95% 65% / 0.3))'
					},
					'50%': { 
						filter: 'brightness(1.2) drop-shadow(0 0 20px hsl(270 95% 65% / 0.5))'
					}
				},
				'spin-slow': {
